...
module.exports = {
  ...
  getNameByCode: function(list, code) {
    ...
    return list && list.length ? list[0].text : '';
  },
  ...
  getCityList: function(code) {
    ...
    return this.getItems(this.city(), code.slice(0, 2) + '0000');
  },
  ...
  getDistrictList: function(code) {
    ...
    return this.getItems(this.district(), code.slice(0, 4) + '00');
  },
  ...
  getProvNameByCode: function(code) {
    ...
    return this.getNameByCode(this.getProvinceList(), code.slice(0, 2) + '0000');
  },
  ...
  getCityNameByCode: function(code) {
    ...
    return this.getNameByCode(this.getCityList(code), code.slice(0, 4) + '00');
  },
